 ...
 * @since 2016-03-09
 */
public class JFXCustomDecorator extends VBox {
    public static final String ROUNDED_DROPSHADOW_STYLE = "-fx-background-color: transparent; -fx-border-width: 1; -fx-border-radius: 8; -fx-border-color: rgba(0,0,0,0.25); -fx-background-radius: 8";
    public static final String NOT_ROUNDED_NO_DROPSHADOW_STYLE = "-fx-background-color: transparent; -fx-background-radius: 0";
    public static final String ROUNDED_TOP_STYLE = "-fx-background-radius: 8 8 0 0";
    public static final String ROUNDED_BOTTOM_STYLE = "-fx-background-radius: 0 0 8 8";
    public static final String NOT_ROUNDED_STYLE = "-fx-background-radius: 0 0 0 0";
     ...
     */
    public JFXCustomDecorator(Stage stage, Node node) {
     ...
     */
    public JFXCustomDecorator(Stage stage, Node node, boolean fullScreen, boolean max, boolean min) {
        primaryStage = stage;
    ...
    private void initializeButtons() {
        ...
        Background whiteTransparentBackground = new Background(new BackgroundFill(Color.web("#ffffff", 0.25), new CornerRadii(4), Insets.EMPTY));
        Background redBackground = new Background(new BackgroundFill(Color.web("#c0392b"), new CornerRadii(4), Insets.EMPTY));
        ...
        btnFull.setOnAction((action) -> {
            ...
            setChildrenNodesRounded();
        });
        btnFull.setOnMouseEntered(action -> btnFull.setBackground(whiteTransparentBackground));
        btnFull.setOnMouseExited(action -> btnFull.setBackground(null));
        ...
        btnClose.setOnMouseEntered(action -> btnClose.setBackground(redBackground));
        btnClose.setOnMouseExited(action -> btnClose.setBackground(null));
        btnClose.setGraphic(close);
        btnClose.setRipplerFill(Color.WHITE);
        btnClose.setDisableVisualFocus(true);
        ...
        btnMin.setOnMouseEntered(action -> btnMin.setBackground(whiteTransparentBackground));
        btnMin.setOnMouseExited(action -> btnMin.setBackground(null));
        ...
        btnMax.setOnMouseEntered(action -> btnMax.setBackground(whiteTransparentBackground));
        btnMax.setOnMouseExited(action -> btnMax.setBackground(null));
    ...
    private void initializeContainers(Node node, boolean fullScreen, boolean max, boolean min) {
        ...
        HBox.setMargin(statusBar, new Insets(2, 42, 0, 8));
        ...
        buttonsContainer.getChildren().addAll(statusBar);
        ...
        // TODO: 15.07.2021 create transparent background
//        setStyle("-fx-background-color: #ffffff03;");

        setChildrenNodesRounded();
    }

    private void setChildrenNodesRounded() {
        if (!maximized) {
            Rectangle clipRoot = new Rectangle();
            clipRoot.widthProperty().bind(widthProperty());
            clipRoot.heightProperty().bind(heightProperty());
            boolean isFullScreen = primaryStage.isMaximized() || primaryStage.isFullScreen() || maximized;
            clipRoot.setArcHeight(isFullScreen ? 0 : 16);
            clipRoot.setArcWidth(isFullScreen ? 0 : 16);
            setClip(clipRoot);

            setStyle(ROUNDED_DROPSHADOW_STYLE);
            for (int i = 0; i < this.getChildren().size(); i++) {
                this.getChildren().get(i).setStyle(i == 0 ? ROUNDED_TOP_STYLE : ROUNDED_BOTTOM_STYLE);
            }
        } else {
            setClip(null);

            setStyle(NOT_ROUNDED_NO_DROPSHADOW_STYLE);
            for (int i = 0; i < this.getChildren().size(); i++) {
                this.getChildren().get(i).setStyle(NOT_ROUNDED_STYLE);
            }
        }
    }
...
//            initY = newY;
     ...
     *
     * @param text
     * @deprecated Use {@link JFXCustomDecorator#setTitle(java.lang.String)} instead.
     */
    @Deprecated
